...
- [Search our issue
  tracker](https://github.com/manifoldco/ruby-manifold-provider/issues/search&type=issues)
  for your problem, someone may have already reported it

# Opening a Pull Request

To contribute, [fork](https://help.github.com/articles/fork-a-repo/)
`ruby-manifoldco-provider`, commit your changes, and [open a pull
...
ruby-manifoldco-provider is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/ruby-manifoldco-provider),
